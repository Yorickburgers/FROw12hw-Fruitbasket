            ...
            <form>
                ...
                <label htmlFor="time-day">
                    <input type="radio" id="time-day" value="day" name="time" checked={formState.time === "day"}
                           onChange={handleChange}/>Overdag</label>
                <label htmlFor="time-night">
                    <input type="radio" id="time-night" value="night" name="time" checked={formState.time === "night"}
                           onChange={handleChange}/>'s avonds</label>
                <Input
                    inputID="comments"
                    inputType="textarea"
                ...
                <label htmlFor="termsConditions">
                    <input type="checkbox" id="termsConditions" name="termsConditions" value={formState.termsConditions}
